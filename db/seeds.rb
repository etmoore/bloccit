...
5.times do
  ...
  # we create an instance of a user which isn't save to the database.
...
user = User.first
user.skip_confirmation!
user.update_attributes(email: 'etmoore@gmail.com', password: 'helloworld', password_confirmation: 'helloworld')

puts "Seed finished"
puts "#{User.count} users created"
puts "#{Post.count} posts created"
puts "#{Comment.count} commments created"